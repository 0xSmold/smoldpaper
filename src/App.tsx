...
const FALLBACK_DICT: Record<string, any> = {
  ...
  es: {
    ...
    decryptPhrasePlaceholder: "Introduce la frase pública...", btnDecrypt: "Descifrar", readsLeft: "Lecturas restantes",
    ...
    infoAlg3: "¡El resto es simple! Chatea normalmente en cualquier mensajería, pero si ves la palabra clave acordada, copia ese mensaje entero de inmediato para descifrar el secreto en SmoldPaper.",
            ...
            <div className="w-full max-w-lg flex flex-col gap-6 px-2 sm:px-0">
              <div className={`p-6 sm:p-8 rounded-2xl border w-full ${themeClasses.bgCard}`}>
                ...
                <form onSubmit={handleEnterRoom}>
                  ...
                  <button type="submit" className={`w-full font-bold py-4 rounded-xl transition-all active:scale-95 flex items-center justify-center ${themeClasses.btnPrimary}`}><Unlock size={20} className="mr-2"/> {t('btnEnter')}</button>
                </form>
              </div>
                ...
                {!decryptedText ? (
                  <div className="max-w-sm mx-auto mt-6 sm:mt-10">
                    ...
                    <form onSubmit={attemptDecrypt}>
                      ...
                      <button type="submit" disabled={isDecrypting || !readPubPhrase} className={`w-full font-bold py-3 rounded-xl transition-transform active:scale-95 ${themeClasses.btnPrimary}`}>{t('btnDecrypt')}</button>
                    </form>
